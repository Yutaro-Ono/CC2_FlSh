...
const float FirstPersonCameraComponent::MAX_PITCH_ANGLE = Math::ToRadians(65.0f);     // 最大仰角
const float FirstPersonCameraComponent::MIN_PITCH_ANGLE = Math::ToRadians(-65.0f);    // 最小仰角
