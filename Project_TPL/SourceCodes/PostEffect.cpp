...
PostEffect::PostEffect()
{
	...
	// ポストエフェクトシェーダのロード
	//m_postEffectShaders[NONE]->Load("Data/Shaders/FB/PostEffectScreen.vert", "Data/Shaders/FB/PostEffectScreen.frag");
	//m_postEffectShaders[INVERT_COLOR]->Load("Data/Shaders/FB/PostEffectScreen.vert", "Data/Shaders/FB/InvertColorScreen.frag");
	//m_postEffectShaders[GREY_SCALE]->Load("Data/Shaders/FB/PostEffectScreen.vert", "Data/Shaders/FB/GreyScaleScreen.frag");
	//m_postEffectShaders[CERNEL]->Load("Data/Shaders/FB/PostEffectScreen.vert", "Data/Shaders/FB/CernelScreen.frag");
	//m_postEffectShaders[BLUR]->Load("Data/Shaders/FB/PostEffectScreen.vert", "Data/Shaders/FB/BlurScreen.frag");
	//m_postEffectShaders[SHARP_EDGE]->Load("Data/Shaders/FB/PostEffectScreen.vert", "Data/Shaders/FB/SharpEdgeScreen.frag");
...
void PostEffect::WritePostEffect()
{
	if (m_shaderNum != 0)
	{
		glBindFramebuffer(GL_FRAMEBUFFER, m_FBO);
...
// ポストエフェクト変更 (デバッグ用)
void PostEffect::DebugPostEffect()
{
#ifdef  _DEBUG
