...
const std::string ResultCarDoor::CAR_DOOR_LEFT_FRAME_MESH_PATH =  "Data/Meshes/Actors/Vehicles/Cars/PlayerCar_SUV/Door/DoorLeft/DoorFrameLeft_Internal.OBJ";
const std::string ResultCarDoor::CAR_DOOR_LEFT_GLASS_MESH_PATH =  "Data/Meshes/Actors/Vehicles/Cars/PlayerCar_SUV/Door/DoorLeft/DoorGlassLeftTransparency_Internal.OBJ";
const std::string ResultCarDoor::CAR_DOOR_RIGHT_FRAME_MESH_PATH = "Data/Meshes/Actors/Vehicles/Cars/PlayerCar_SUV/Door/DoorRight/DoorFrameRight_Internal.OBJ";
const std::string ResultCarDoor::CAR_DOOR_RIGHT_GLASS_MESH_PATH = "Data/Meshes/Actors/Vehicles/Cars/PlayerCar_SUV/Door/DoorRight/DoorGlassRightTransparency_Internal.OBJ";
