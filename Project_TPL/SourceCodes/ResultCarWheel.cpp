...
const std::string ResultCarWheel::CAR_WHEEL_RUBBER_MESH_PATH = "Data/Meshes/Actors/Vehicles/Cars/PlayerCar_SUV/Wheel/WheelRubber_Internal.OBJ";
const std::string ResultCarWheel::CAR_WHEEL_STEEL_MESH_PATH =  "Data/Meshes/Actors/Vehicles/Cars/PlayerCar_SUV/Wheel/WheelSteel_Internal.OBJ";
