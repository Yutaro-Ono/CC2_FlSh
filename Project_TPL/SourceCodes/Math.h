...
// 2‚Â‚ÌƒxƒNƒgƒ‹‚Í‚Ù‚Ú“¯‚¶Šp“x‚©
bool isNearAngle(const Vector3& v1, const Vector3& v2);

// nowVec‚©‚çdirVec‚ÌÅ’Z‚Ì‰ñ“]•ûŒü‚ð’²‚×‚éiZŽ²‰ñ“]‚ð‘z’è)
// ŽžŒv‰ñ‚è•ûŒü‚ÌŽž‚Í+1.0 ”½ŽžŒv‰ñ‚è•ûŒü‚ÌŽž‚Í -1.0‚ð•Ô‚·
float calcRotateZDirection(const Vector3& nowVec, const Vector3& dirVec);

// nowVec‚©‚ç aimVec‚ÉŒü‚©‚Á‚ÄdegreeVerociy‚Ì‘¬“x‚ÅZ‰ñ“]‚·‚éB
